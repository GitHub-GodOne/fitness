...
import {
  DEFAULT_COMFLY_IMAGE_EDIT_PROMPT,
  ...
  DEFAULT_COMFLY_SCRIPT_SYSTEM_PROMPT,
  DEFAULT_COMFLY_TTS_SPEED,
...
export async function getSettingTabs(tab: string) {
  ...
  const tabs: Tab[] = [
    ...
    {
      name: 'comfly',
      title: t('edit.tabs.comfly'),
      url: '/admin/settings/comfly',
      is_active: tab === 'comfly',
    },
    {
      name: 'ads',
...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'comfly',
      title: 'Comfly API',
      description: 'custom your Comfly API prompt settings',
      tab: 'comfly',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'comfly_image_edit_prompt',
      title: 'Comfly Image Edit Prompt',
      type: 'textarea',
      value: DEFAULT_COMFLY_IMAGE_EDIT_PROMPT,
      attributes: {
        rows: 8,
      },
      metadata: {
        testAction: {
          provider: 'comfly',
          promptType: 'image_edit',
          execute: true,
          requiresImage: true,
          title: 'Test Image Edit Prompt',
          description:
            'Uploads or uses a test image URL, then runs the backend image-edit request with the current unsaved prompt.',
        },
      },
      placeholder: 'Prompt used when editing the uploaded image before video generation',
      group: 'comfly',
      tab: 'ai',
      tip: 'Used by nano-banana image editing. Leave empty to use the built-in default prompt.',
    },
    {
      name: 'comfly_default_video_prompt',
      title: 'Comfly Default Video Prompt',
      type: 'textarea',
      value: DEFAULT_COMFLY_VIDEO_PROMPT,
      attributes: {
        rows: 8,
      },
      metadata: {
        testAction: {
          ...
          execute: false,
          requiresImage: true,
          title: 'Test Video Prompt',
          description:
            'Use a test image to preview the backend video-generation request payload built from the current unsaved prompt.',
        },
      },
      placeholder: 'Default fallback prompt used when no custom video prompt is provided by the user',
      group: 'comfly',
      tab: 'ai',
      tip: 'Used by Wanx video generation when the request does not provide a custom prompt.',
    },
    {
      name: 'comfly_script_system_prompt',
      title: 'Comfly Script System Prompt',
      type: 'textarea',
      value: DEFAULT_COMFLY_SCRIPT_SYSTEM_PROMPT,
      attributes: {
        rows: 16,
      },
      metadata: {
        testAction: {
          ...
          description:
            'Sends a real backend script-generation request with the current unsaved system prompt.',
          sampleInput: 'I feel lonely and anxious tonight',
        },
      },
      placeholder: 'System prompt used to generate Bible verse narration JSON',
      group: 'comfly',
      tab: 'ai',
      tip: 'Controls the script-writing behavior for verse reference, verse text, and narration generation.',
    },
    {
      name: 'comfly_tts_voice',
      title: 'Comfly TTS Voice File',
      type: 'text',
      value: DEFAULT_COMFLY_TTS_VOICE,
      placeholder: 'output.wav',
      group: 'comfly',
      tab: 'ai',
      tip: 'Voice file sent to the Comfly TTS endpoint. This value is used by both Test Audio Generation and the formal generation flow.',
    },
    {
      ...
      group: 'comfly',
      tab: 'ai',
      tip: 'Default speech speed for Comfly TTS. After saving, the same speed is used in the real generation workflow.',
    },
    {
      name: 'comfly_merge_bgm_url',
      title: 'Comfly Merge BGM URL',
      type: 'url',
      value: DEFAULT_COMFLY_MERGE_BGM_URL,
      placeholder: 'https://example.com/music.mp3',
      group: 'comfly',
      tab: 'ai',
      tip: 'Optional background music URL used by Comfly video merge.',
    },
    {
      name: 'comfly_merge_bgm_volume',
      title: 'Comfly Merge BGM Volume',
      type: 'number',
      value: DEFAULT_COMFLY_MERGE_BGM_VOLUME,
      attributes: {
        step: '0.1',
      },
      placeholder: '3',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default background music volume for Comfly video merge.',
    },
    {
      name: 'comfly_merge_voice_volume',
      title: 'Comfly Merge Voice Volume',
      type: 'number',
      value: DEFAULT_COMFLY_MERGE_VOICE_VOLUME,
      attributes: {
        step: '0.1',
      },
      placeholder: '1.0',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default narration volume for Comfly video merge.',
    },
    {
      name: 'comfly_merge_max_words_per_line',
      title: 'Comfly Merge Max Words Per Line',
      type: 'number',
      value: DEFAULT_COMFLY_MERGE_MAX_WORDS_PER_LINE,
      attributes: {
        step: '1',
      },
      placeholder: '20',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default subtitle wrapping for Comfly video merge.',
    },
    {
      name: 'comfly_merge_long_token_dur_s',
      title: 'Comfly Merge Long Token Duration (s)',
      type: 'number',
      value: DEFAULT_COMFLY_MERGE_LONG_TOKEN_DUR_S,
      attributes: {
        step: '0.1',
      },
      placeholder: '0.8',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default subtitle hold duration for longer words during Comfly video merge.',
    },
    {
      name: 'volcano_engine_api_key',
      title: 'Volcano Engine API Key',
      type: 'password',
      placeholder: 'ARK_API_KEY',
      group: 'volcano',
      tab: 'ai',
      tip: 'Volcano Engine API Key (ARK_API_KEY) is used to access the Volcano Engine API',
    },
    {
      name: 'volcano_custom_storage',
      title: 'Volcano Custom Storage',
      type: 'switch',
      value: 'false',
      group: 'volcano',
      tab: 'ai',
      tip: 'Use custom storage to save files generated by Volcano Engine',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
