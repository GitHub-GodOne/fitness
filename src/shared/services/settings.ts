...
import {
  ...
  DEFAULT_COMFLY_MERGE_TITLE_X,
  DEFAULT_COMFLY_MERGE_TITLE_Y,
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'comfly_merge_subtitle_fontsize',
      title: 'Comfly Merge Subtitle Font Size',
      type: 'number',
      value: DEFAULT_COMFLY_MERGE_SUBTITLE_FONTSIZE,
      attributes: {
        step: '1',
      },
      placeholder: '100',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default subtitle font size for Comfly video merge.',
    },
    {
      name: 'comfly_merge_subtitle_marginv',
      title: 'Comfly Merge Subtitle Bottom Margin',
      type: 'number',
      value: DEFAULT_COMFLY_MERGE_SUBTITLE_MARGINV,
      attributes: {
        step: '1',
      },
      placeholder: '100',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default subtitle bottom margin for Comfly video merge.',
    },
    {
      name: 'comfly_merge_subtitle_y',
      title: 'Comfly Merge Subtitle Y',
      type: 'text',
      value: DEFAULT_COMFLY_MERGE_SUBTITLE_Y,
      placeholder: '0',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default subtitle Y coordinate for Comfly video merge. Use values from 0 up to the video height.',
    },
    {
      name: 'comfly_merge_title_fontsize',
      title: 'Comfly Merge Title Font Size',
      type: 'number',
      value: DEFAULT_COMFLY_MERGE_TITLE_FONTSIZE,
      attributes: {
        step: '1',
      },
      placeholder: '80',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default title font size for Comfly video merge.',
    },
    {
      name: 'comfly_merge_title_x',
      title: 'Comfly Merge Title X',
      type: 'number',
      value: DEFAULT_COMFLY_MERGE_TITLE_X,
      attributes: {
        step: '1',
      },
      placeholder: '540',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default title X coordinate for Comfly video merge.',
    },
    {
      name: 'comfly_merge_title_y',
      title: 'Comfly Merge Title Y',
      type: 'number',
      value: DEFAULT_COMFLY_MERGE_TITLE_Y,
      attributes: {
        step: '1',
      },
      placeholder: '300',
      group: 'comfly',
      tab: 'ai',
      tip: 'Default title Y coordinate for Comfly video merge.',
    },
    {
