        ...
        <div className="flex gap-2 sm:gap-3">
          ...
          <div className="flex-1 min-w-0 space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
              <span className="text-sm sm:text-base font-semibold">{comment.userName}</span>
                ...
                <div className="rounded-lg border bg-muted/50 p-2 sm:p-3">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-2 text-xs sm:text-sm text-muted-foreground">
                      ...
                      <span className="text-xs sm:text-sm">{t('item.referenced')}</span>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-4">
              ...
              >
                <ThumbsUp
                  className={cn('h-3.5 w-3.5 sm:h-4 sm:w-4', isLiked && 'fill-current')}
                />
              ...
              >
                ...
                <span>{comment.replies > 0 ? comment.replies : t('item.reply')}</span>
                {comment.replies > 0 &&
                  (showReplies ? (
