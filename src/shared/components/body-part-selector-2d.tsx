...
interface BodyPartSelector2DProps {
  selected: string[];
      ...
      <div className="w-full max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4">
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-sm font-medium mb-2">{t("front_view")}</h3>
            <svg
              viewBox="0 0 660.46 1206.46"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="w-full h-[500px] lg:h-[700px] object-contain"
            >
            <defs>
            ...
            <g
              ...
              className={cn(
                ...
                isSelected("calves") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("abdominals") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
              onClick={() => toggle("abdominals")}
            >
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("obliques") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
              onClick={() => toggle("obliques")}
            >
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("chest") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("biceps") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("front-shoulders") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
              onClick={() => toggle("front-shoulders")}
            >
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("traps") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("forearms") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
              onClick={() => toggle("forearms")}
            >
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("hands") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
            ...
            {/* Body Outline - Front */}
            <g id="body-outline-front" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46">
              {/* Left side body outline */}
              <path d="M163.96,299.82h.04" />
              <path d="M174.18,297.7h.04c7.63-1.9,13.62-4.2,17.35-6.79,13.04-9.03,23.37-21.44,28.14-27.15,14.81-17.79,17.05-25.8,32.65-35.93,8.58-5.57,19.32-8.96,19.32-8.96,0,0-25.8-10.83-50.18-5.82h-.02" />
              <path d="M271.11,219.05c4.42-1.26,13.42-4.71,30.78-3.02,28.47,2.76,28.17,21.92,28.17,21.92v49.79c0,10.17-3.4,20.09-9.85,27.83-5.5,6.61-13.59,13.92-24.94,18.98-27.94,12.47-60.65,3.65-80.05-20.38-7.28-9.02-15.3-16.9-29.68-16.9" />
              <path d="M289.56,162.48v37.06c0,11.68-7.04,15.63-17.89,19.34-.54.18-1.1.36-1.67.52" />

              {/* Center torso */}
              <line x1="330.05" y1="504.57" x2="330.05" y2="571.92" />
              <line x1="330.17" y1="504.57" x2="330.17" y2="571.92" />
              <line x1="330.29" y1="504.57" x2="330.29" y2="571.92" />
              <line x1="330.4" y1="504.57" x2="330.4" y2="571.92" />

              <path d="M330.05,340.19c0-16.6-24.92-9.38-34.79-5.64-10.73,4.06-19.35,8.64-22.18,15.17-3.41,7.86,3.69,12.72,4.53,33.36.22,5.38-.28,4.69-.19,15.43.09,11.2,2.29,60.48,4.34,93.33,3.22,51.71,34.57,94.43,48.29,94.43" />
              ...
              {/* Right side mirror */}
              <path d="M496.5,299.82h-.04" />
              <path d="M486.27,297.7h-.04c-7.63-1.9-13.62-4.2-17.35-6.79-13.04-9.03-23.37-21.44-28.14-27.15-14.81-17.79-17.05-25.8-32.65-35.93-8.58-5.57-19.32-8.96-19.32-8.96,0,0,25.8-10.83,50.18-5.82h.02" />
              <path d="M389.35,219.05c-4.42-1.26-13.42-4.71-30.78-3.02-28.47,2.76-28.17,21.92-28.17,21.92v49.79c0,10.17,3.4,20.09,9.85,27.83,5.5,6.61,13.59,13.92,24.94,18.98,27.94,12.47,60.65,3.65,80.05-20.38,7.28-9.02,15.3-16.9,29.68-16.9" />
              <path d="M370.9,162.48v37.06c0,11.68,7.04,15.63,17.89,19.34.54.18,1.1.36,1.67.52" />

              <path d="M330.4,340.19c0-16.6,24.92-9.38,34.79-5.64,10.73,4.06,19.35,8.64,22.18,15.17,3.41,7.86-3.69,12.72-4.53,33.36-.22,5.38.28,4.69.19,15.43-.09,11.2-2.29,60.48-4.34,93.33-3.22,51.71-34.57,94.43-48.29,94.43" />
              ...
              {/* Lower body */}
              <path d="M218.37,317.78c23.5,26.93,57.29,48.52,58.93,60.58,2.16,15.96-10.33,48.95-6.29,77.1,4.04,28.16-3.04,46.44-12.16,55.38-6.96,6.82-19.03,9.86-29.31,7.43" />
              <path d="M229.53,518.28c19.21,4.08,52.48,20.12,65.45,64.94,12.97,44.82,19.66,61.4,35.08,61.4" />
              <path d="M206.28,783.67c5.85,26.98,7.58,56.74,28.95,46.03,13.1-6.59,2.82,30.89,26.81,31.31,23.99.41,31.22-52.55,31.22-52.55" />
              <path d="M273.39,881.54c-.16.29-.32.56-.46.83-15.13,26.11-38.4,28.46-48.59,9.57-4.85-8.96-7.91-12.75-15.04-14.45" />

              <path d="M442.09,317.78c-23.5,26.93-57.29,48.52-58.93,60.58-2.16,15.96,10.33,48.95,6.29,77.1-4.04,28.16,3.04,46.44,12.16,55.38,6.96,6.82,19.03,9.86,29.31,7.43" />
              <path d="M430.93,518.28c-19.21,4.08-52.48,20.12-65.45,64.94-12.97,44.82-19.66,61.4-35.08,61.4" />
              <path d="M454.18,783.67c-5.85,26.98-7.58,56.74-28.95,46.03-13.1-6.59-2.82,30.89-26.81,31.31-23.99.41-31.22-52.55-31.22-52.55" />
              ...
              <path d="M145.75,308.53c2.76-1.9,6.01-3.82,9.75-5.55,11.35-5.19,20.97-5.55,22.92-5.6,8.44-.25,16.47-.47,22.46,4.53,10.6,8.82,7.57,27.94,6.41,35.27-.62,3.82-1.53,7.4-2.65,10.74" />
              <path d="M165.89,397.13c-18.42,22.99-34.28,22.87-41.87,19.05-12.72-6.41-19.87-27.43,3.8-80.98,0-.02,0-.05.02-.07" />

              <path d="M514.71,308.53c-2.76-1.9-6.01-3.82-9.75-5.55-11.35-5.19-20.97-5.55-22.92-5.6-8.44-.25-16.47-.47-22.46,4.53-10.6,8.82-7.57,27.94-6.41,35.27.62,3.82,1.53,7.4,2.65,10.74" />
              <path d="M494.57,397.13c18.42,22.99,34.28,22.87,41.87,19.05,12.72-6.41,19.87-27.43-3.8-80.98,0-.02,0-.05-.02-.07" />

              {/* Head */}
              <path d="M282.82,83.56s.54-14.9,0-24.54c-.54-9.63,6.51-27.77,16.85-22.43,10.89,5.63,32.28,10.76,58.33,0,7.35-2.26,14.26,10.09,15.52,24.09,1.25,14,2.69,21.23,4.3,22.88" />
              <path d="M370.84,135.77s-10.57,20.48-40.26,25.91" />
              <path d="M289.97,135.77s10.57,20.48,40.26,25.91" />
              <path d="M282.69,83.67c-5.36-3.86-3.61-20.07-6.05-37.39-2.56-18.19,16.27-32.16,24.89-34.59,5.86-1.65-18.28,1.29,6.39-6.76s33.37,2.13,37.66,3.41c3.74-.45-9.93-8.43,11.87-1.12,20.36,6.82,23.77,22.8,22.07,39.35-2.2,21.32,2.15,29.08-1.76,37.1" />
          ...
          {/* Back View */}
          <div className="flex flex-col items-center">
            <h3 className="text-sm font-medium mb-2">{t("back_view")}</h3>
          <svg
            viewBox="0 0 660.46 1206.46"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("traps-middle") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
              onClick={() => toggle("traps-middle")}
            >
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("glutes") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("triceps") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("lats") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
              onClick={() => toggle("lats")}
            >
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("lowerback") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
              onClick={() => toggle("lowerback")}
            >
            ...
            <g
              ...
              className={cn(
                "cursor-pointer transition-colors",
                isSelected("rear-shoulders") ? "text-red-500" : "text-gray-400 hover:text-red-300"
              )}
              onClick={() => toggle("rear-shoulders")}
            >
            ...
            {/* Body Outline - Back */}
            <g id="body-outline-back" fill="none" stroke="#484a68" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52">
              {/* Head */}
              <path d="M330.26,131.3c15.78,0,25.12,12.03,29.48,9.51,4.35-2.51,8.07-13.01,16.41-23.77,8.34-10.76-.36-12.56,9.08-42.7,9.43-30.14-14.51-56.46-20.68-60.41-6.17-3.95,17.41,10.04,4.72-3.23-12.7-13.27-38.46-4.3-46.44-2.15s27.21-9.69,0-6.1c-22.12,2.92-39.92,14.6-46.79,34.66" />
              <path d="M330.26,131.3c-15.79,0-25.13,12.03-29.48,9.51-4.36-2.51-8.08-13.01-16.42-23.77s.36-12.56-9.07-42.7c-1.49-4.74-2.14-17.9-2.17-22.01v-.04c-.04-5.66,1.11-10.73,2.93-15.18" />

              {/* Shoulders and neck */}
              <path d="M228.95,211.29c1.57-.7,9.71-6.15,14.7-8.41s25.39-10.44,30.52-12.98c5.14-2.54,14.41-11.57,14.41-11.57l.25-3.16c.72-7.78,1.02-39.35,1.02-39.35-2.91-5.76-3.49-15.57-3.49-15.57-7.29,1.44-12.53-1.87-13.99-21.04-.83-10.94,2.52-14.45,5.55-15.44" />
              <path d="M382.62,83.78c3.02,1,6.37,4.51,5.54,15.44-1.46,19.17-6.71,22.48-13.99,21.04,0,0-.58,9.81-3.5,15.57,0,0,.29,31.57,1.03,39.35l.24,3.16s9.27,9.03,14.41,11.57c5.14,2.54,25.54,10.73,30.53,12.98s13.13,7.71,14.69,8.41" />
              ...
              {/* Mid back */}
              <path d="M264.67,231.03c52.5,96.35,51.77,138.65,65.59,138.65" />
              <path d="M395.85,231.03c-52.5,96.35-51.77,138.65-65.59,138.65" />
              ...
              {/* Lower back and hips */}
              <path d="M306.02,320.31c16.1,39.45,8.58,62.94-20.42,117.65-15.8,29.81,7.37,62.98-19.95,73.7-17.48,6.86-43.08,23.91-44.85,40.85" />
              <path d="M354.5,320.31c-16.1,39.45-8.58,62.94,20.42,117.65,15.8,29.81-7.37,62.98,19.95,73.7,17.48,6.86,43.08,23.91,44.85,40.85" />

              <path d="M199.54,339.06c7.74-12.38-13.12-52.58,0-60.72" />
              <path d="M460.98,339.06c-7.74-12.38,13.12-52.58,0-60.72" />

              {/* Glutes and legs */}
              <line x1="330.26" y1="553.71" x2="330.26" y2="614.06" />

              <path d="M330.26,614.06c0,35.81-24.38,31.69-49.78,30.16-27.16-1.64-63.32-19.3-43.62-80.18,8.85-27.35,8.53-46.89,35.82-54.97,19.3-5.72,57.58-4.57,57.58,44.65" />
              <path d="M330.26,614.06c0,35.81,24.38,31.69,49.78,30.16,27.16-1.64,63.32-19.3,43.62-80.18-8.85-27.35-8.53-46.89-35.82-54.97-19.3-5.72-57.58-4.57-57.58,44.65" />

              {/* Legs */}
              <path d="M203,791.63s13.43,96.36,35.71,40.85c22.28-55.5-1.29,32.07,27.64,32.07,13.1,0,21.17-19.38,28.81-70.69" />
              <path d="M457.52,791.63s-13.43,96.36-35.71,40.85c-22.28-55.5,1.29,32.07-27.64,32.07-13.1,0-21.17-19.38-28.81-70.69" />

              {/* Calves and feet */}
              <path d="M183.71,965.72c1.71,31.85,5.8,54.85,19.28,55.65,13.93.82,20.85-31.78,26.38-31.31,6.93.59-.18,31.18,15.44,34.42,4.79.99,14.84,1.64,24-22.13" />
              <path d="M476.8,965.72c-1.71,31.85-5.8,54.85-19.28,55.65-13.93.82-20.85-31.78-26.38-31.31-6.93.59.18,31.18-15.44,34.42-4.79.99-14.84,1.64-24-22.13" />
