            ...
            return (
              <NavigationMenuItem key={idx}>
                ...
                <NavigationMenuContent className="min-w-2xs origin-top p-0.5">
                  <div className="border-foreground/5 bg-background ring-foreground/5 rounded-[calc(var(--radius)-2px)] border border-border/50 p-2 shadow ring-1 backdrop-blur-sm">
