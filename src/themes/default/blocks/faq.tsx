              ...
              {section.items?.map((item, idx) => (
                <div className="group" key={idx}>
                  <AccordionItem
                    ...
                    className="bg-background/90 peer rounded-lg sm:rounded-xl border-none px-4 sm:px-6 md:px-7 py-1 data-[state=open]:border-none data-[state=open]:shadow-sm transition-colors duration-200"
                  >
