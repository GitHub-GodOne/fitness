...
export function Showcases({
  ...
  return (
    ...
    >
      ...
      >
        <DialogContent className="!max-w-7xl !w-[95vw] !h-[95vh] md:!h-auto md:!max-h-[90vh] !p-0 flex flex-col gap-0">
          <DialogHeader className="px-4 md:px-6 pt-4 md:pt-6 pb-3 md:pb-4 flex-shrink-0 border-b">
            <DialogTitle className="text-lg md:text-2xl line-clamp-2">
              {selectedVideo?.title}
            </DialogTitle>
          </DialogHeader>
          {selectedVideo && (
          ...
          {selectedVideo?.description && (
            <div className="px-4 md:px-6 pb-4 md:pb-6 pt-3 md:pt-4 flex-shrink-0 max-h-32 md:max-h-40 overflow-y-auto border-t">
              <p
