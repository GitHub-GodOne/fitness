...
export const envConfigs: ConfigMap = {
  ...
  app_logo: process.env.NEXT_PUBLIC_APP_LOGO ?? '/logo-icon.png',
  app_favicon: process.env.NEXT_PUBLIC_APP_FAVICON ?? '/logo-icon.png',
  app_preview_image:
  ...
  // CDN domain for replacing R2 storage URLs
